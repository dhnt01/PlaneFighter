...
OFILES = main.o gameboy.o gameover.o playing.o myLib.o lives.o font.o fighter.o enemy3.o startscreen.o winscreen.o

# The header files you have created.
# This is necessary to determine when to recompile for files.
# This should be a space (SPACE!) separated list of .h files
HFILES = gameboy.h myLib.h font.h gameover.h playing.h lives.h fighter.h enemy3.h startscreen.h winscreen.h
